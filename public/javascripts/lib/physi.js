window.Physi = (function() {
	'use strict';

	var SUPPORT_TRANSFERABLE,
		_is_simulating = false,
		_Physi = Physi, // used for noConflict method
		Physi = {}, // object assigned to window.Physi
		Eventable, // class to provide simple event methods
		getObjectId, // returns a unique ID for a Physi mesh object
	...
	Physi.createMaterial = function( material, friction, restitution ) {
	...
	// Constraints
	Physi.PointConstraint = function( objecta, objectb, position ) {
	...
	Physi.PointConstraint.prototype.getDefinition = function() {
		return {
			type: this.type,
			id: this.id,
	...
	Physi.HingeConstraint = function( objecta, objectb, position, axis ) {
		if ( axis === undefined ) {
			axis = position;
			position = objectb;
			objectb = undefined;
	...
	Physi.HingeConstraint.prototype.getDefinition = function() {
		return {
			type: this.type,
			id: this.id,
			objecta: this.objecta,
	 ...
	 */
	Physi.HingeConstraint.prototype.setLimits = function( low, high, bias_factor, relaxation_factor ) {
	...
	Physi.HingeConstraint.prototype.enableAngularMotor = function( velocity, acceleration ) {
		this.scene.execute( 'hinge_enableAngularMotor', { constraint: this.id, velocity: velocity, acceleration: acceleration } );
	};
	Physi.HingeConstraint.prototype.disableMotor = function( velocity, acceleration ) {
		this.scene.execute( 'hinge_disableMotor', { constraint: this.id } );
	};

	Physi.SliderConstraint = function( objecta, objectb, position, axis ) {
		if ( axis === undefined ) {
			axis = position;
			position = objectb;
			objectb = undefined;
	...
	Physi.SliderConstraint.prototype.getDefinition = function() {
		return {
			type: this.type,
			id: this.id,
			objecta: this.objecta,
	...
	Physi.SliderConstraint.prototype.setLimits = function( lin_lower, lin_upper, ang_lower, ang_upper ) {
	...
	Physi.SliderConstraint.prototype.setRestitution = function( linear, angular ) {
		this.scene.execute(
	...
	Physi.SliderConstraint.prototype.enableLinearMotor = function( velocity, acceleration) {
		this.scene.execute( 'slider_enableLinearMotor', { constraint: this.id, velocity: velocity, acceleration: acceleration } );
	};
	Physi.SliderConstraint.prototype.disableLinearMotor = function() {
		this.scene.execute( 'slider_disableLinearMotor', { constraint: this.id } );
	};
	Physi.SliderConstraint.prototype.enableAngularMotor = function( velocity, acceleration ) {
		this.scene.execute( 'slider_enableAngularMotor', { constraint: this.id, velocity: velocity, acceleration: acceleration } );
	};
	Physi.SliderConstraint.prototype.disableAngularMotor = function() {
		this.scene.execute( 'slider_disableAngularMotor', { constraint: this.id } );
	};

	Physi.ConeTwistConstraint = function( objecta, objectb, position ) {
		if ( position === undefined ) {
	...
	Physi.ConeTwistConstraint.prototype.getDefinition = function() {
		return {
			type: this.type,
			id: this.id,
			objecta: this.objecta,
	...
	Physi.ConeTwistConstraint.prototype.setLimit = function( x, y, z ) {
		this.scene.execute( 'conetwist_setLimit', { constraint: this.id, x: x, y: y, z: z } );
	};
	Physi.ConeTwistConstraint.prototype.enableMotor = function() {
		this.scene.execute( 'conetwist_enableMotor', { constraint: this.id } );
	};
	Physi.ConeTwistConstraint.prototype.setMaxMotorImpulse = function( max_impulse ) {
		this.scene.execute( 'conetwist_setMaxMotorImpulse', { constraint: this.id, max_impulse: max_impulse } );
	};
	Physi.ConeTwistConstraint.prototype.setMotorTarget = function( target ) {
	...
	Physi.ConeTwistConstraint.prototype.disableMotor = function() {
		this.scene.execute( 'conetwist_disableMotor', { constraint: this.id } );
	};

	Physi.DOFConstraint = function( objecta, objectb, position ) {
		if ( position === undefined ) {
			position = objectb;
			objectb = undefined;
		}
	...
	Physi.DOFConstraint.prototype.getDefinition = function() {
		return {
			type: this.type,
			id: this.id,
			objecta: this.objecta,
	...
	Physi.DOFConstraint.prototype.disableAngularMotor = function( which ) {
		this.scene.execute( 'dof_disableAngularMotor', { constraint: this.id, which: which } );
	};

	// Physi.Scene
	Physi.Scene = function( params ) {
		var self = this;

		Eventable.call( this );
		THREE.Scene.call( this );

		this._worker = new Worker( Physi.scripts.worker || 'physijs_worker.js' );
		...
		params = params || {};
		params.ammo = Physi.scripts.ammo || 'ammo.js';
		params.fixedTimeStep = params.fixedTimeStep || 1 / 60;
		params.rateLimit = params.rateLimit || true;
		this.execute( 'init', params );
	};
	Physi.Scene.prototype = new THREE.Scene;
	Physi.Scene.prototype.constructor = Physi.Scene;
	Eventable.make( Physi.Scene );

	Physi.Scene.prototype._updateScene = function( data ) {
	...
	Physi.Scene.prototype._updateVehicles = function( data ) {
		var vehicle, wheel,
			i, offset;
	...
	Physi.Scene.prototype._updateConstraints = function( data ) {
	...
	Physi.Scene.prototype._updateCollisions = function( data ) {
		/**
		 * #TODO
	...
	Physi.Scene.prototype.addConstraint = function ( constraint, show_marker ) {
	...
	Physi.Scene.prototype.onSimulationResume = function() {
		this.execute( 'onSimulationResume', { } );
	};

	Physi.Scene.prototype.removeConstraint = function( constraint ) {
	...
	Physi.Scene.prototype.execute = function( cmd, params ) {
	...
	Physi.Scene.prototype.add = function( object ) {
		...
		if ( object._physijs ) {
			...
			if ( object instanceof Physi.Vehicle ) {
	...
	Physi.Scene.prototype.remove = function( object ) {
		if ( object instanceof Physi.Vehicle ) {
	...
	Physi.Scene.prototype.setFixedTimeStep = function( fixedTimeStep ) {
		if ( fixedTimeStep ) {
			this.execute( 'setFixedTimeStep', fixedTimeStep );
		}
	};

	Physi.Scene.prototype.setGravity = function( gravity ) {
		if ( gravity ) {
			this.execute( 'setGravity', gravity );
		}
	};

	Physi.Scene.prototype.simulate = function( timeStep, maxSubSteps ) {
	...
	// Phsijs.Mesh
	Physi.Mesh = function ( geometry, material, mass ) {
		var index;
	...
	Physi.Mesh.prototype = new THREE.Mesh;
	Physi.Mesh.prototype.constructor = Physi.Mesh;
	Eventable.make( Physi.Mesh );

	// Physi.Mesh.mass
	Physi.Mesh.prototype.__defineGetter__('mass', function() {
		return this._physijs.mass;
	});
	Physi.Mesh.prototype.__defineSetter__('mass', function( mass ) {
	...
	// Physi.Mesh.applyCentralImpulse
	Physi.Mesh.prototype.applyCentralImpulse = function ( force ) {
		if ( this.world ) {
			this.world.execute( 'applyCentralImpulse', { id: this._physijs.id, x: force.x, y: force.y, z: force.z } );
		}
	};

	// Physi.Mesh.applyImpulse
	Physi.Mesh.prototype.applyImpulse = function ( force, offset ) {
		if ( this.world ) {
	...
	// Physi.Mesh.applyTorque
	Physi.Mesh.prototype.applyTorque = function ( force ) {
		if ( this.world ) {
			this.world.execute( 'applyTorque', { id: this._physijs.id, torque_x: force.x, torque_y: force.y, torque_z: force.z } );
		}
	};

	// Physi.Mesh.applyCentralForce
	Physi.Mesh.prototype.applyCentralForce = function ( force ) {
		if ( this.world ) {
			this.world.execute( 'applyCentralForce', { id: this._physijs.id, x: force.x, y: force.y, z: force.z } );
		}
	};

	// Physi.Mesh.applyForce
	Physi.Mesh.prototype.applyForce = function ( force, offset ) {
		if ( this.world ) {
	...
	// Physi.Mesh.getAngularVelocity
	Physi.Mesh.prototype.getAngularVelocity = function () {
		return this._physijs.angularVelocity;
	};

	// Physi.Mesh.setAngularVelocity
	Physi.Mesh.prototype.setAngularVelocity = function ( velocity ) {
		if ( this.world ) {
			this.world.execute( 'setAngularVelocity', { id: this._physijs.id, x: velocity.x, y: velocity.y, z: velocity.z } );
		}
	};

	// Physi.Mesh.getLinearVelocity
	Physi.Mesh.prototype.getLinearVelocity = function () {
		return this._physijs.linearVelocity;
	};

	// Physi.Mesh.setLinearVelocity
	Physi.Mesh.prototype.setLinearVelocity = function ( velocity ) {
		if ( this.world ) {
			this.world.execute( 'setLinearVelocity', { id: this._physijs.id, x: velocity.x, y: velocity.y, z: velocity.z } );
		}
	};

	// Physi.Mesh.setAngularFactor
	Physi.Mesh.prototype.setAngularFactor = function ( factor ) {
		if ( this.world ) {
			this.world.execute( 'setAngularFactor', { id: this._physijs.id, x: factor.x, y: factor.y, z: factor.z } );
		}
	};

	// Physi.Mesh.setLinearFactor
	Physi.Mesh.prototype.setLinearFactor = function ( factor ) {
		if ( this.world ) {
			this.world.execute( 'setLinearFactor', { id: this._physijs.id, x: factor.x, y: factor.y, z: factor.z } );
		}
	};

	// Physi.Mesh.setDamping
	Physi.Mesh.prototype.setDamping = function ( linear, angular ) {
		if ( this.world ) {
			this.world.execute( 'setDamping', { id: this._physijs.id, linear: linear, angular: angular } );
		}
	};

	// Physi.Mesh.setCcdMotionThreshold
	Physi.Mesh.prototype.setCcdMotionThreshold = function ( threshold ) {
		if ( this.world ) {
			this.world.execute( 'setCcdMotionThreshold', { id: this._physijs.id, threshold: threshold } );
		}
	};

	// Physi.Mesh.setCcdSweptSphereRadius
	Physi.Mesh.prototype.setCcdSweptSphereRadius = function ( radius ) {
		if ( this.world ) {
	...
	// Physi.PlaneMesh
	Physi.PlaneMesh = function ( geometry, material, mass ) {
		var width, height;

		Physi.Mesh.call( this, geometry, material, mass );
	...
	Physi.PlaneMesh.prototype = new Physi.Mesh;
	Physi.PlaneMesh.prototype.constructor = Physi.PlaneMesh;

	// Physi.HeightfieldMesh
	Physi.HeightfieldMesh = function ( geometry, material, mass, xdiv, ydiv) {
		Physi.Mesh.call( this, geometry, material, mass );
	...
	Physi.HeightfieldMesh.prototype = new Physi.Mesh;
	Physi.HeightfieldMesh.prototype.constructor = Physi.HeightfieldMesh;

	// Physi.BoxMesh
	Physi.BoxMesh = function( geometry, material, mass ) {
	...
	Physi.BoxMesh.prototype = new Physi.Mesh;
	Physi.BoxMesh.prototype.constructor = Physi.BoxMesh;


	// Physi.SphereMesh
	Physi.SphereMesh = function( geometry, material, mass ) {
		Physi.Mesh.call( this, geometry, material, mass );
	...
	Physi.SphereMesh.prototype = new Physi.Mesh;
	Physi.SphereMesh.prototype.constructor = Physi.SphereMesh;


	// Physi.CylinderMesh
	Physi.CylinderMesh = function( geometry, material, mass ) {
		var width, height, depth;
	...
	Physi.CylinderMesh.prototype = new Physi.Mesh;
	Physi.CylinderMesh.prototype.constructor = Physi.CylinderMesh;


	// Physi.CapsuleMesh
	Physi.CapsuleMesh = function( geometry, material, mass ) {
		var width, height, depth;
	...
	Physi.CapsuleMesh.prototype = new Physi.Mesh;
	Physi.CapsuleMesh.prototype.constructor = Physi.CapsuleMesh;


	// Physi.ConeMesh
	Physi.ConeMesh = function( geometry, material, mass ) {
		var width, height, depth;
	...
	Physi.ConeMesh.prototype = new Physi.Mesh;
	Physi.ConeMesh.prototype.constructor = Physi.ConeMesh;


	// Physi.ConcaveMesh
	Physi.ConcaveMesh = function( geometry, material, mass ) {
		var i,
			width, height, depth,
	...
	Physi.ConcaveMesh.prototype = new Physi.Mesh;
	Physi.ConcaveMesh.prototype.constructor = Physi.ConcaveMesh;


	// Physi.ConvexMesh
	Physi.ConvexMesh = function( geometry, material, mass ) {
		var i,
			width, height, depth,
			points = [];
	...
	Physi.ConvexMesh.prototype = new Physi.Mesh;
	Physi.ConvexMesh.prototype.constructor = Physi.ConvexMesh;


	// Physi.Vehicle
	Physi.Vehicle = function( mesh, tuning ) {
		tuning = tuning || new Physi.VehicleTuning;
		this.mesh = mesh;
		this.wheels = [];
		this._physijs = {
			id: getObjectId(),
	...
	Physi.Vehicle.prototype.addWheel = function( wheel_geometry, wheel_material, connection_point, wheel_direction, wheel_axle, suspension_rest_length, wheel_radius, is_front_wheel, tuning ) {
	...
	Physi.Vehicle.prototype.setSteering = function( amount, wheel ) {
	...
	Physi.Vehicle.prototype.setBrake = function( amount, wheel ) {
		if ( wheel !== undefined && this.wheels[ wheel ] !== undefined ) {
	...
	Physi.Vehicle.prototype.applyEngineForce = function( amount, wheel ) {
		if ( wheel !== undefined && this.wheels[ wheel ] !== undefined ) {
	...
	// Physi.VehicleTuning
	Physi.VehicleTuning = function( suspension_stiffness, suspension_compression, suspension_damping, max_suspension_travel, friction_slip, max_suspension_force ) {
